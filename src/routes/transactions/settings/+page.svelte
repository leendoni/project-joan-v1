...
<SideNav bind:isOpen={isSideNavOpen}>
	<SideNavItems>
		...
		<SideNavDivider />
		<SideNavLink icon={Money} href="../transactions" text="Financial Transactions" />
		<SideNavLink isSelected icon={Currency} href="../transactions/settings" text="Financial Settings" />
		<SideNavDivider />
