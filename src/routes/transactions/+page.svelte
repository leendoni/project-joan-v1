...
<Header company="Project" platformName="JOAN" href="/" bind:isSideNavOpen>
	<div class="text-white hidden lg:flex pr-10">Colegio de San Juan de Dios, Incorporated</div>
	<HeaderUtilities>
		<div class="flex">
			<div class="flex">
				<Button
...
<SideNav bind:isOpen={isSideNavOpen}>
	<SideNavItems>
		...
		<SideNavDivider />
		<SideNavLink icon={UserAdmin} href="../admin" text="Administrator Dashboard" />
		<SideNavDivider />
		...
		<SideNavDivider />
		<SideNavLink isSelected icon={Money} href="../transactions" text="Financial Transactions" />
		<SideNavLink icon={Currency} href="../transactions/settings" text="Financial Settings" />
		<SideNavDivider />
